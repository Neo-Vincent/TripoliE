...
class TripoliPost(BaseTripoli):
    ...
    def _compute_concentration(self):
        ...
        for v in self.volume:
            ...
            for isotope in self.isotopes:
                try:
                    if isotope == 'U235':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope]) * delta_bu
                    if isotope == 'U236':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['U235']) * delta_bu
                    if isotope == 'NP237':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['U236']) * delta_bu
                    if isotope == 'PU238':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['NP237']) * delta_bu
                    if isotope == 'U238':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope]) * delta_bu
                    if isotope == 'PU239':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['PU238']) * delta_bu
                    if isotope == 'PU240':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['PU239']) * delta_bu
                    if isotope == 'PU241':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['PU240']) * delta_bu
                    if isotope == 'PU242':
                        the_v[isotope] = self.concentration[v][isotope] - (self.score[v][33][isotope] +
                                                                           self.score[v][52][isotope] -
                                                                           self.score[v][52]['PU241']) * delta_bu
                except KeyError:
    ...
    def generateTable(self):
        ...
        for reaction in self.reaction:
            ...
            for isotope in self.isotopes:
                table += '\t' + isotope + '\t' + '%E\t' * rows % tuple(
                    [self.score[vol][reaction][isotope] for vol in volume]) + '\n'
        table += '\nconcentration'
        for isotope in self.isotopes:
            table += '\t' + isotope + '\t' + '%E\t' * rows % tuple(
                self.concentration[vol][isotope] for vol in volume) + '\n'
